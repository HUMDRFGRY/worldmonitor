...
<p align="center">
  <a href="./docs/documentation_CN.mdx"><strong>文档</strong></a> &nbsp;·&nbsp;
...
如需查看完整功能列表、架构、数据源和算法，请参阅 **[文档](./docs/documentation_CN.mdx)**。
...
有关部署选项（Vercel、Docker、静态），请参阅 **[自托管指南](./docs/getting-started_CN.mdx)**。
...
完整技术细节请见 **[架构文档](./docs/architecture_CN.mdx)**。
...
WorldMonitor 汇聚了 30+ 个外部数据源，覆盖地缘政治、金融、能源、气候、航空和网络安全。有关提供方、订阅层级和采集方式的完整信息，请参阅 [数据源目录](./docs/data-sources_CN.mdx)。
...
<p align="center">
  ...
  <a href="./docs/documentation_CN.mdx">documentation</a> &nbsp;·&nbsp;
