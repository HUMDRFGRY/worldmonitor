...
The provider-backed targeted stock-news layer is documented separately in [PREMIUM_FINANCE_SEARCH.md](./premium-finance-search.mdx).
...
See [PREMIUM_FINANCE_SEARCH.md](./premium-finance-search.mdx).
