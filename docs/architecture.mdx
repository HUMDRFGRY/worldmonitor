...
> **CORS** — all API endpoints enforce an origin allowlist. See [CORS.md](./cors.mdx) for the allowed origins, implementation details, and how to add CORS to new endpoints.
